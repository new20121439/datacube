...
class Query(BaseQuery):
    ...
    # TODO: Are there querytypes, animation types that need to be distinguished?
    ...
    base_result_dir = '/datacube/ui_results/download'
...
class DownloadTask(Query, Metadata, Result):
    """
    Combines the Query, Metadata, and Result abstract models
    """

class SentinelResult(models.Model):
    # Add more field
    download_task_id = models.ForeignKey(DownloadTask, on_delete=models.CASCADE)        
    uuid = models.CharField(max_length=250, default="")
    title = models.CharField(max_length=100, default="")
    link_icon = models.CharField(max_length=250, default="")
    link = models.CharField(max_length=250, default="")
    size = models.CharField(max_length=30, default="0 GB")
    producttype = models.CharField(max_length=40, default="")
    endposition = models.DateTimeField()

    # Sentinel 1 does not have these attr
    # processinglevel = models.CharField(max_length=40, default="")
    # platformserialidentifier = models.CharField(max_length=40, default="")
