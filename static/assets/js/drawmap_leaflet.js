...
/**
 * Given a tile layer name, create a map base layer.
 * The options are ['osm', 'googleSat'].
 * The option 'osm' provides an OpenStreetMap layer.
 * The option 'googleSat' provides a Google Satellite layer.
 */
 ...
 *    tile_layer_name: string of the tile layer to use for the map
 *        options are ['osm', 'googleSat'].
 *        The option 'osm' provides an OpenStreetMap view.
 *        The option 'googleSat' provides a Google satellite view.
 */
function DrawMap(container_id, options) {
    ...
    // Set the tile layer.
    if ('tile_layer_name' in options) {
        this.map.addLayer(create_map_base_layer(options.tile_layer_name));
    }
